...
// ── Five acts, six annotation panels ─────────────────────────────────────────
...
const PANELS = [
  ...
  },
  {
    ...
    body:  'The field self-organises into the planform Bressloff et al. (2001) predict for V1 under elevated cortical excitability — the gain increase hallucinogens are thought to induce via 5HT2A action. This geometry is intrinsic to the cortical connectivity kernel — independent of the image beneath it.',
  ...
  // Act VI — Super symmetry finale (left)
  {
    ...
    body:  'z → log(z). The complex logarithm maps the visual field to primary visual cortex. The fovea expands to cover ~50% of V1 surface area; the periphery compresses. Radial symmetry becomes total. This is the coordinate system in which V1 computes — and in which the planform lives.',
    start: 0.84, peak: 0.90, end: 0.98,
  },
  // Act VI — Entity emergence (right panel, appears with finale)
  {
    title: 'Autonomous Entities',
    body:  'Bilateral symmetry activates the fusiform face area. V1\'s planform — bilateral, radially symmetric, hexagonally nodal — is structurally indistinguishable from a face. Nodes of peak excitation become eyes. Axial ridges become bodies.\n\nHigher cortex completes the pattern. Objects may acquire agency, depth, intention. McKenna\'s machine elves might emerge not from imagination but from the deterministic output of a neural field at supercritical gain.\n\nOnly α has changed. Whether that is sufficient to explain entity encounters is an open question.',
